#NOTE: this is an old "metrics.py" script from https://github.com/google/uncertainty-baselines/tree/main/baselines/toxic_comments.
#The authors have changed their current metrics script to only include a subset of the functions in here. Now they are using the robustness_metrics library for the functions they delted.
#I kept working with this file.
